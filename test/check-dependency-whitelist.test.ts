...
const THIS_PACKAGE = '@nerima-games/mc-noise'
...
describe('mc-noise dependency policy', () => {
  it.effect('declares no direct dependencies: mc-noise is a tier-1 library and needs only the kernel vocabulary', () =>
    Effect.sync(() => {
