 ...
 *
 * ---------------------------------------------------------------------------
 * For mc-noise the allowed set is EMPTY, which reads as "kernel and nothing
 * else". mc-noise is a tier-1 stable library: seeded deterministic noise is a
 * pure function of (seed, coordinate), so it needs the shared vocabulary and no
 * services whatsoever. If this row ever grows, that is a design smell first and
 * a configuration change second.
 *
...
export const REPOSITORY_POLICY = {
  thisPackage: '@nerima-games/mc-noise',
