...
export const PERMUTATION_MASK = PERMUTATION_SIZE - UNIT_DIMENSION
...
export const AMPLITUDE_SCALE_3D = Math.sqrt(THREE_DIMENSIONS)

/** Offset to the opposite lattice corner along one axis. */
export const LATTICE_NEIGHBOR_OFFSET = UNIT_DIMENSION

/** Increment for stateful loops over permutation indices. */
export const LOOP_STEP = UNIT_DIMENSION
