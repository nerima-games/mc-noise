{
  description = "mc-noise: Seeded deterministic noise, portable Minecraft density functions, and sampling primitives. The seed -> value interface is a frozen contract.";
    ...
    in
    {
      devShells = forAllSystems (
        ...
        in
        {
          ...
          # a different version without anyone noticing, because the config file
          # (`.oxlintrc.json`) had a filename
